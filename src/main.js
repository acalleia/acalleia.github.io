$(function () {    
    ...
    let $Projects = $('<a id="ProjectsBtn" class="nav">Projects</a>').appendTo('.navBar');
    
    let $AboutNav = $('<a id="AboutBtn" class="nav">About</a>').appendTo('.navBar');
    
    let $Contact = $('<a id="ContactBtn" class="nav">Contact</a>').appendTo('.navBar');
